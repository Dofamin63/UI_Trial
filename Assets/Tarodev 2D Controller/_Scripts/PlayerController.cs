...
namespace TarodevController
{
    ...
    /// You can play and compete for best times here: https://tarodev.itch.io/
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        {
            if (leftButtonPressed) x = -1f;
            else if (rightButtonPressed) x = 1f;
            else x = 0f;

            _frameInput = new FrameInput
            {
                JumpDown = Input.GetButtonDown("Player1_Jump") || Input.GetKeyDown(KeyCode.C) || jumpButtonDown,
                // JumpHeld = Input.GetButton("Player1_Jump") || Input.GetKey(KeyCode.C) || jumpButtonDown,
        ...
        private void CheckCollisions()
        {
            ...
            // Ground and Ceiling
            _groundHitCount = Physics2D.CapsuleCastNonAlloc(_col.bounds.center, _col.size, _col.direction, 0,
                Vector2.down, _groundHits, _stats.GrounderDistance, ~_stats.PlayerLayer);
            _ceilingHitCount = Physics2D.CapsuleCastNonAlloc(_col.bounds.center, _col.size, _col.direction, 0,
